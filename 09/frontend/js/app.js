const apiUrlBase = 'http://localhost/renato/tii09-uc7/09/api/clientes_api.php'; // Ajuste se necessário
...
const apiUrlProdutos = 'http://localhost/renato/tii09-uc7/09/api/produtos_api.php'; // Ajuste se necessário
